<?php
	...
	echo "<div class='col-md-12 container ' id='main_songs_head'><div class='row'><div class='col-md-7'><h2><strong>My Albums</strong></h2></div><div class='col-md-5'><input id='myInput' type='text' class='form-control' placeholder='search albums' style='margin-top:8px;'></div></div>";
	for($i=1;$i<=$nrow;$i++)
	{
	...
	<div class='col-md-3 col-sm-6'  id="song_card" style="margin-bottom: 10px;">
	 ...
	 <?php echo "<button class='btn btn-default' data-placement='top' title='Play all songs' data-toggle='tooltip' onclick='call_to_start_playlist(".json_encode($song_id_list).",".json_encode($song_name_list).")' style='background-color:#e22727;'>" ?>
