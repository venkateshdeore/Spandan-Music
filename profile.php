...
$query="SELECT * FROM user_details WHERE uid=$profile_id";
...
<body>
    ...
    <div class="col-md-9 backcolor" style="margin-bottom: 50px;">
       

        <!-- Caraousel -->
        <div class="container" id="modal_song_id">
      ...
      <hr>
      <div>
        <h2><strong><?php echo $profile_name;?></strong></h2>
      </div>
      <div>
      <?php include 'album_fetch_profile.php' ?>
      </div>
      <!-- <hr> -->
      <div>
      <?php include 'song_fetch_profile.php' ?>
      </div>
      <!-- <hr> -->
