...
<body>
    ...
    <div class=" w3-sidebar w3-bar-block w3-card w3-animate-left" style="background-color:rgb(35,35,35); color:white; padding:5px;" id="leftMenu">
      ...
      <a href="all_albums_fetch.php" class="w3-bar-item w3-button"  style="text-decoration:none;" id='active1'><i style="color:red;"class="iconmenu fa fa-book"></i> &nbsp;   Albums</a>
      <?php 
    ...
    <!-- Beginning of middle part --><br>
    <div class="col-md-9 backcolor" style="padding:20px;">
      ...
      <br>
      <div >
      <?php include 'all_albums_fetch_display.php' ?>
      </div>
      <!-- <hr> -->
    ...
    <div class=" col-md-1 backcolor" >
    <!-- <div class="w3-sidebar w3-bar-block w3-card "  id="rightMenu">
        <button onclick="closeRightMenu()" class="w3-bar-item w3-button w3-large" id="close">Close &times;</button>
    </div>
    <div class="w3-teal" id="collapse-button">
