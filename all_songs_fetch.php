...
<body>
    ...
    <div class=" w3-sidebar w3-bar-block w3-card w3-animate-left" style="background-color:rgb(35,35,35); color:white; padding:5px;" id="leftMenu">
      ...
      <a href="all_songs_fetch.php" class="w3-bar-item w3-button" style="text-decoration:none;" id="active1"><i style="color:red;"class="iconmenu fa fa-music"></i>  &nbsp;    My songs</a><hr>
    ...
    <div class="col-md-9 backcolor">
      ...
      <div>
      <?php include 'all_songs_fetch_display.php' ?>
      </div>
      <!-- <hr> -->
